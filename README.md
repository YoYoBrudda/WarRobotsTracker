...
This version saves the row crop used for OCR into the `Crops` folder. The crop keeps the same filename as the original screenshot so you can compare what the app saw against the original image.
